      ...
      <div className="mt-auto space-y-4 pt-6">
        ...
        >
          <div className="flex justify-between items-center mb-3">
            <span
              className={`text-[10px] font-semibold uppercase tracking-wider ${isDark ? "text-zinc-500" : "text-slate-500"}`}
            >
              Connected Sources
            </span>
        ...
        >
          ...
          <p
            className={`text-[11px] mt-1 leading-normal mb-3 ${isDark ? "text-zinc-500" : "text-slate-500"}`}
          >
        ...
        {/* External Links */}
        <div
          className={`flex flex-col gap-1.5 pt-4 border-t ${isDark ? "border-zinc-850" : "border-slate-100"}`}
        >
          <a
            href="#"
